...
- [ ] **Audio.** Sound effects and ten music loops exist (2026-09-20) and
      ...
      out (`tools/gen_sfx.py` and `tools/gen_music.py` re-tune them). The
      loops are 19.2 s each and will wear; decide whether they ship as the
      final music or as placeholders.
